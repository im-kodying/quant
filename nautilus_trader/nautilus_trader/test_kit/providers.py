...
class TestDataProvider:
    """
    Provides an API to load data from either the 'ib-gateway/' directory or the projects
    GitHub repo.
    ...
    def _test_data_directory() -> str | None:
        # Determine if the ib-gateway data directory exists (i.e. this is a checkout of the source code).
    ...
    def _determine_filesystem(self) -> None:
        ...
        if test_data_dir:
            ...
            print("Couldn't find ib-gateway data directory, ib-gateway data will be pulled from GitHub")
