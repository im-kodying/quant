...
class TestDataProvider:
    """
    Provides an API to load data from either the 'ibkr/' directory or the projects
    GitHub repo.
    ...
    def _test_data_directory() -> str | None:
        # Determine if the ibkr data directory exists (i.e. this is a checkout of the source code).
    ...
    def _determine_filesystem(self) -> None:
        ...
        if test_data_dir:
            ...
            print("Couldn't find ibkr data directory, ibkr data will be pulled from GitHub")
